...
// initialize the the character array of length 8;
...
// print the binary of given character
void pbin(int x){ 
  	char tmp[8]="00000000";
	printf("x = %d\n", x);
  	int i=7;
...
int main(){
  ...
  char b[][8]={"10101","10111","111","1001","010101"};
  printf("%lu sizeof\n",sizeof(b));
  ...
  // wrinting all elements of b array into file.
  /*
  ...
  while(i<5){
    	if(j>0 && k<strlen(b[i])){
      		...
      		tmp=tmp|tmp2;  // tmp bitwiseOr tmp2
      		pbin(tmp);
      		pbin(tmp);
      		j--;
      		printf("j = %d\n", j);
...
*/
// reading file and finding meaning according to the b array
//  /*
